...
import { settingsOutline, personOutline, trophyOutline, calendarOutline, ribbonOutline, chevronForwardOutline, flashOutline } from 'ionicons/icons';
    ...
    <IonPage>
      <IonHeader className="ion-no-border">
        <IonToolbar>
          ...
          <IonTitle style={{ fontWeight: '800', letterSpacing: '2px', textTransform: 'uppercase' }}>Mi Liga</IonTitle>
          <IonButtons slot="end">
            <IonButton>
      ...
      <IonContent className="ion-padding">
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          <IonImg src={LeagueIcon} style={{ width: '90px', height: '90px', margin: '0 auto', filter: 'drop-shadow(0 0 15px rgba(255, 61, 113, 0.3))' }} />
          <h1 style={{ fontSize: '28px', fontWeight: '800', margin: '15px 0 5px 0' }}>LIGA PRO-FIGHT</h1>
          <IonText color="medium">
            <p style={{ margin: 0, textTransform: 'uppercase', letterSpacing: '2px', fontSize: '12px', fontWeight: 'bold' }}>División Regional Madrid</p>
          </IonText>
        </div>
          ...
          <IonRow>
            <IonCol>
              <div style={{ background: 'rgba(255, 61, 113, 0.1)', borderRadius: '15px', padding: '12px', border: '1px solid rgba(255, 61, 113, 0.2)', textAlign: 'center' }}>
                ...
                <h3 style={{ margin: '5px 0 0 0', fontWeight: '800' }}>8 / 12</h3>
            ...
            <IonCol>
              <div style={{ background: 'rgba(255, 255, 255, 0.03)', borderRadius: '15px', padding: '12px', border: '1px solid var(--fcx-border-color)', textAlign: 'center' }}>
                ...
                <h3 style={{ margin: '5px 0 0 0', fontWeight: '800' }}>1.250</h3>
